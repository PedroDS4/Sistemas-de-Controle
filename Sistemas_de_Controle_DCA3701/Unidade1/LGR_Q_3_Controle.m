...
title(['$\mathrm{LGR:}\; G(s)=\frac{N(s)}{D(s)}$', newline, ...
       '$\mathrm{Polos}=', mat2str(p,3), '\;, \;', ...
       '\mathrm{Zeros}=', mat2str(z,3), '\;, \;', ...
       '\sigma_A=', num2str(sigma_A,3), '\;, \;', ...
       'L_s=', num2str(LS), '\;, \;', ...
       '\phi_A=', mat2str(phi_A,3), '\;, \;', ...
       '\sigma_{out}=', mat2str(sigma_out,3), '\;, \;', ...
       '\omega_c=', mat2str(w_cross,3), '\;, \;', ...
       '\phi_{in}=', mat2str(phi_in,3), '\;, \;', ...
       '\theta_{out}=', mat2str(theta_out,3), '$'], ...
       'Interpreter','latex')
